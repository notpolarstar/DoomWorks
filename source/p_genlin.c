...
manual_lift:
    ...
    S_StartSound2(&g_dummy_soundorg,sfx_pstart);
...
manual_locked:
    ...
    S_StartSound2(&g_dummy_soundorg,   // killough 4/15/98
    ...
    switch(Kind)
    {
      case OdCDoor:
        ...
        if (door->topheight != sec->ceilingheight)
          S_StartSound2(&g_dummy_soundorg,Sped>=SpeedFast ? sfx_bdopn : sfx_doropn);
      ...
      case CdODoor:
        ...
        door->direction = -1;
        S_StartSound2(&g_dummy_soundorg,Sped>=SpeedFast ? sfx_bdcls : sfx_dorcls);
